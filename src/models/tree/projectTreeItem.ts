...
import { DatabaseProjectItemType, RelativeOuterPath, ExternalStreamingJob, pgProjExtension } from '../../common/constants';
...
export class ProjectRootTreeItem extends BaseProjectTreeItem {
	...
	constructor(project: Project) {
		super(vscode.Uri.parse(path.basename(project.projectFilePath, pgProjExtension)), undefined);
	...
	public get treeItem(): vscode.TreeItem {
		...
		projectItem.label = path.basename(this.projectUri.fsPath, pgProjExtension);
